...
type HumanBrain struct {
	Mouth neure.Mouth // word output network
	Body  neure.Body  // make an action that use body

	Eyes         neure.NeureEntrance // 視覺神經的觸發神經元
	Ear          neure.NeureEntrance // 聽覺神經的觸發神經元
	Language     neure.NeureEntrance // language input entrance
